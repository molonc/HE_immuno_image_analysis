...
macro_fn="/home/htran/storage/images_dataset/large_tissue/macro/color_deconv/detect_mask_CD8.txt"
...
log_file="$log_dir/color_deconv/detect_mask_CD8.log"
exec >> $log_file 2>&1 && tail $log_file

xvfb-run -a java -Xmx30000m -jar $imagej_dir/ij.jar -ijpath $imagej_dir/ -batch $macro_fn $input_dir 
