...
## Linux command
# log_file="/home/htran/storage/images_dataset/HE_10_33214/macro/cell_type/cell_type_CD57.log"
...
# macro_fn="/home/htran/storage/images_dataset/HE_10_33214/macro/cell_type/cell_type_CD57.txt"
...
macro_fn="$macro_dir/cell_type/cell_type_CD57_v2.txt"
...
mkdir $log_dir
log_file="$log_dir/ct_${marker1}_${series}_1.log"
echo $log_file
exec >> $log_file 2>&1 && tail $log_file

input_dir1="${project_dir}${series}/${marker1}_tiles/NUC/NUC_SEG/"
